...
```
YOUR ANSWER GOES HERE:
first one: type - character, class - character, all other elements convert to the string since it is the only type they can all convert into.
...
Answer:
The vector is repeated times equal to the second element.
