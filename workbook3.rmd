...
class(cool_list[1][1])
#the class of cool_list[1] is a list, and so does the cases when random numbers of '[1]' are added after the first '[1]'; as a result, getting the first element of a list always gives a list of first element 
```
